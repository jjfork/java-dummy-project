...
public class ServiceGeneratedAiTests {
    ...
    void testHighComplexityMethod_GivenAllPositive() {
        ...
        // THEN the expected output should be printed: "a is positive", "b is positive", "c is positive"
    }
    ...
    void testHighComplexityMethod_GivenAPositive() {
        ...
        // WHEN highComplexityMethod is called with the inputs
        service.highComplexityMethod(a, b, c);
        // THEN the expected output should be printed: "a is positive", "b is non-positive", "c is non-positive"
    }
    ...
    void testHighComplexityMethod_GivenANonPositive() {
        ...
        // WHEN highComplexityMethod is called with the inputs
        service.highComplexityMethod(a, b, c);
        // THEN the expected output should be printed: "a is non-positive", "b is positive", "c is positive"
    }
