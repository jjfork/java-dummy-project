...
public class MergeSortedArrayListTests {
    ...
    @Test
    public void testMerge_whenBothListsAreEmpty_thenResultIsEmpty() {
    ...
    @Test
    public void testMerge_whenOneListIsEmpty_thenResultIsOtherList() {
    ...
    @Test
    public void testMerge_whenBothListsAreNonEmpty_thenResultIsMergedAndSorted() {
