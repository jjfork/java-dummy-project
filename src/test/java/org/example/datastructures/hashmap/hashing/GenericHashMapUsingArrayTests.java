...
public class GenericHashMapUsingArrayTests {
    ...
    @Test
    public void givenExistingKey_whenPut_thenValueUpdated() {
        hashMap.put("one", 1);
        hashMap.put("one", 2);
    ...
    @Test
    public void givenKey_whenContainsKey_thenTrue() {
        hashMap.put("one", 1);
        assertThat(hashMap.containsKey("one")).isTrue();
    }

    @Test
    public void givenNonExistingKey_whenContainsKey_thenFalse() {
